        ...
        <div class="reg-form d-flex align-items-center justify-content-center mt-5">
            <form class="registration-form" method="POST" action="{{ route('register') }}">
                ...
                <div class="inputForm">
                    ...
                    <input placeholder="Easypaisa" class="input" type="text" name="our_bank" value="Easypaisa"
                        disabled>
                </div>
                @error('our_bank')
                    <p class="error text-danger mb-0">{{ $message }}</p>
                ...
                <!-- Bank Username -->
                <div class="flex-column">
                    <label for="bank_username">Enter Your Bank Username*</label>
                </div>
                <div class="inputForm">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <path fill="none" d="M0 0h24v24H0V0z" />
                    ...
                    <input placeholder="Your bank's username" class="input" type="text" name="bank_username"
                        required autofocus autocomplete="bank_username">
                </div>
                @error('bank_username')
                    <p class="error text-danger mb-0">{{ $message }}</p>
                @enderror
                ...
                <div class="inputForm">
                    ...
                    <input placeholder="Your number from where you sent registeration fees" class="input"
                        type="number" name="sender_number" required autofocus autocomplete="sender_number">
                </div>
                @error('sender_number')
                    <p class="error text-danger mb-0">{{ $message }}</p>
                @enderror
                ...
                <div class="inputForm">
                    ...
                    <input placeholder="Enter TID or TRX num or Transcation" class="input" type="text"
                        name="TRX_number" required autofocus autocomplete="TRX_number">
                </div>
                @error('TRX_number')
                    <p class="error text-danger mb-0">{{ $message }}</p>
                @enderror
