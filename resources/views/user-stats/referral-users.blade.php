    ...
    <script>
        ...
        document.getElementById('withdrawForm').addEventListener('submit', function(event) {
            ...
            withdrawModalBody.innerHTML =
                'Your withdrawal request has been submitted successfully. It will take almost 2 hours to process your request. Please wait patiently. Keep checking your withdraw status in your dashboard.😊';
            withdrawModal.show();
        });
    </script>
